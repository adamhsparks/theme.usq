...
Currently the development version of
[_ggplot2_](https://github.com/tidyverse/ggplot2) is required and also needs
to be installed from GitHub. Once a new version is released on CRAN, I will
update the dependencies of _theme.usq_ to rely on the CRAN version of _ggplot2_.
